...
router.patch("/:id", authenticate, authorize("election.commission.manage"), ElectionController.update);
...
router.get("/:electionId/voting-stats", authenticate, authorize("election.read"), ElectionController.getVotingStats);
...
// Generic get by ID removed - now at top to avoid route conflicts
